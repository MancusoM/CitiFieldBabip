"""this file generates a png visualizing the Mets' BABIP at/away from Citi Field"""
...
def retrieveMetsAPIData() -> pl.DataFrame:
    ...
    for year in range(2009, 2025):
        ...
        try:
            ...
            print(f"Successfully Processed the Mets {year} season")
        except RuntimeError:
            raise ValueError("Please Troubleshoot API")
        MetsYearReturn = pl.from_pandas(batting_logs)

        # Adds Year To Return
        MetsYearReturn = MetsYearReturn.with_columns(Year=pl.lit(year))
